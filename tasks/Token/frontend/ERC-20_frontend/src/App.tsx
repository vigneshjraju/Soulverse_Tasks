...
import { CONTRACT_ABI } from "./abi/abi.ts"; // works fine even if it's .js
...
const CONTRACT_ADDRESS = "0xB1e19139D382d891dd7fc6F6BB1744acE03Fd594"; // Replace with your deployed proxy address
